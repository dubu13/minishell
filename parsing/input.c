 ...
 *
 * The prompt includes the current user's username,
 ...
 * this function uses readline() to read a line of input from the user,
	displays a prompt
 ...
 *
	...
	* @param mini A pointer to the t_mini struct containing the program's environment.
 * @return The user's input as a null-terminated string,
	or NULL if an error occurs or
